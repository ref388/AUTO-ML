...
def _inject_css_once():
    ...
    .xp-stat-card .s-value { color:#e6edf3; font-size:1.4rem; font-weight:700; font-family:'Space Mono',monospace; }
    .xp-stat-card .s-value.blue   { color:#58a6ff; }
    .xp-stat-card .s-value.green  { color:#3fb950; }
    .xp-stat-card .s-value.amber  { color:#d29922; }
    .xp-stat-card .s-value.purple { color:#bc8cff; }
    ...
    .xp-insight strong { color:#bc8cff; }
    .xp-insight .xp-i-text { color:#e6edf3; font-size:.92rem; }
    ...
    .xp-feat-rank.gold { color:#d29922; }
    .xp-feat-name { color:#e6edf3; font-weight:600; font-size:.92rem; flex:1; }
    .xp-feat-val {
        font-family:'Space Mono',monospace;
        font-size:.85rem; color:#58a6ff; font-weight:700;
    }
    .xp-feat-bar-wrap { width:140px; background:#21262d; border-radius:4px; height:6px; }
    .xp-feat-bar { height:6px; border-radius:4px; background:#58a6ff; }
    </style>
